...
# === LOGO ===
st.image("https://raw.githubusercontent.com/Alonso-droid/mpedge-app/main/MPEdge%20logo.png", width=80)
st.title("📘 MPEdge")
...
selected_chapter = st.selectbox("📂 AND you MUST pick a chapter manually (Click Here to access the subject matter index https://www.uspto.gov/web/offices/pac/mpep/mpep-index-a.html):", chapter_names)
